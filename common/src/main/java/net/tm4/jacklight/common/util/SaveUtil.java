package net.tm4.jacklight.common.util;
...
public final class SaveUtil {
    ...
    private static void loadLightHookReal(final Level world, final ChunkPos pos, final CompoundTag tag, final ChunkAccess into) {
        ...
        SWMRNibbleArray[] blockNibbles = JackLightEngine.getFilledEmptyLight(world);
        SWMRNibbleArray[] skyNibbles = JackLightEngine.getFilledEmptyLight(world);
